...
class GameplayCustomizeState extends MusicBeatState
{
	...
	public override function create()
	{
		...
		if (!ClientPrefs.changedHit)
		{
			ClientPrefs.changedHitX = defaultX;
			ClientPrefs.changedHitY = defaultY;
		}

		sick.x = ClientPrefs.changedHitX;
		sick.y = ClientPrefs.changedHitY;
	...
	override function update(elapsed:Float)
	{
		...
		{
			ClientPrefs.changedHitX = sick.x;
			ClientPrefs.changedHitY = sick.y;
			ClientPrefs.changedHit = true;
		}
