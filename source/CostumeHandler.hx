...
class CostumeHandler
{
	public static final costumes:Map<CostumeName, CostumeInfo> = [
		...
		FEVER_MINUS => {
			displayName: "Fever (Minus)",
			description: "On Minus difficulty, beat Week 2 and 7. (Story Mode)",
			character: "bf-minus",
			creator: "EMG"
		},
		FEVER_OG => {
			displayName: "Fever (O.G)",
			description: "Play a version of Friday Night Fever before v1.4 or beat Weeks 1 through 6.",
			character: "bf-old",
			creator: "Kip"
		},
		TEASAR => {
			displayName: "Teasar",
			description: "On Baby difficulty, full combo Milk Tea.",
			character: "teasar",
			creator: "Circle"
		}
	];
